...
import griffon.groovy.model.DefaultTableColumn
...
class SwingBuilderTableTest extends GroovySwingTestCase {
    ...
    void testClosureColumn() {
        ...
        assert table.columnModel.class.name == 'griffon.groovy.model.DefaultTableModel$MyTableColumnModel'
    }
    ...
    public void testTableBindSyntheticProperties() {
        ...
        println swing.t1e.text
        println swing.t1se.text
        println swing.t1ses.text
        ...
        println swing.t2e.text
        println swing.t2se.text
        println swing.t2ses.text
